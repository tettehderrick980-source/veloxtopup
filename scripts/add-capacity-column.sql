-- Add capacity column to transactions table if it doesn't exist
-- Run this in your Supabase SQL Editor

-- Make user_id nullable to support guest transactions
...
AND column_name IN ('capacity', 'cost_price', 'selling_price', 'profit', 'margin_percentage', 'vendor_reference');
